...
function buildNav(members) {
    ...
    nav += buildMemberNav(members.namespaces, 'Schemas', seen, linkto);
    //nav += buildMemberNav(members.classes, 'Tables', seen, linkto);
...
exports.publish = (taffyData, opts, tutorials) => {
    ...
    Object.keys(helper.longnameToUrl).forEach(longname => {
        ...
        if (myNamespaces.length) {
            generate(`Schema: ${myNamespaces[0].name}`, myNamespaces, helper.longnameToUrl[longname]);
        }
